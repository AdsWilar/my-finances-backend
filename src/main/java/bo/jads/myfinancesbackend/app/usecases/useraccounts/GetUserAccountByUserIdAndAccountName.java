...
@AllArgsConstructor
@Component
public class GetUserAccountByUserIdAndAccountName
        implements BaseUseCase<GetUserAccountByUserIdAndAccountName.Param, UserAccount> {
    ...
    public UserAccount execute(Param param) throws UserAccountNotFoundException {
        return userAccountRepository
                .findByUserIdAndAccountName(param.getUserId(), param.getAccountName().trim().toUpperCase())
